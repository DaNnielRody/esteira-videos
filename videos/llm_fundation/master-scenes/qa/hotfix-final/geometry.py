...
for name,windows,end in [
    ("TokensERepresentacoesScene",[(0,67.52)],67.52),
    ("OQueCriouOChatGPTScene",[(45.05,48.75)],49),
    ("OLimiteDoDicionarioScene",[(0,20.5),(55.5,57.5)],58),
    ("AEscadaEAPerguntaScene",[(41.4,49.17)],50),
]:
