...
class LinearMapReference(VisualScene):
    def construct(self):
        plane = NumberPlane()
        basis = VGroup(
...
class DerivativeReference(VisualScene):
    def construct(self):
...
class NeuralNetworkReference(VisualScene):
    def construct(self):
        layers = VGroup(*[
...
class RegressionReference(VisualScene):
    def construct(self):
...
class AttentionReference(VisualScene):
    def construct(self):
...
class BayesianUpdateReference(VisualScene):
    def construct(self):
...
class FourierReference(VisualScene):
    def construct(self):
...
class ConvolutionReference(VisualScene):
    def construct(self):
        values = [1, 3, 2, 4, 1]
        cells = VGroup(*[
