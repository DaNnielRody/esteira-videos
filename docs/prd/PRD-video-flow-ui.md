...
|---|---|---|
| Reuse the existing loopback Ollama generate provider | https://docs.ollama.com/api/generate | Ollama 0.33.2 |
| Keep the locally validated Qwen coder model | https://ollama.com/library/qwen2.5-coder:7b | qwen2.5-coder:7b; `ollama list` ID dae161e27b0e; blob SHA-256 60e05f2100071479f596b964f89f510f057ce397ea22f2833a0cfe029bfc2463 |
| Reuse the canonical Manim renderer | https://pypi.org/project/manim/0.21.0/ | Manim Community 0.21.0 |
| Reuse the canonical FFmpeg/ffprobe media boundary | https://ffmpeg.org/ffmpeg.html | 6.1.1-3ubuntu5 |
| Run browser E2E against the supported geckodriver contract | https://firefox-source-docs.mozilla.org/testing/geckodriver/Support.html | Firefox 153.0.4; geckodriver 0.37.0 |

This delivery changes none of those provider, model, renderer or browser
decisions, adds no shipping dependency, and keeps real inference outside the
deterministic gate.

Observed on 2026-08-30: `ollama list` returned
`qwen2.5-coder:7b dae161e27b0e 4.7 GB`; `ollama show
qwen2.5-coder:7b --modelfile` returned the `FROM` blob SHA-256 recorded above.
